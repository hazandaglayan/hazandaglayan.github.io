...
* Vary S., Daglayan, H., Jacques, L., Absil, P-A. (2023). "Low-rank plus sparse trajectory decomposition for direct exoplanet imaging." 2023 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), pp. 1-5. [\[paper\]](https://ieeexplore.ieee.org/document/10096197) [\[code\]](https://github.com/hazandaglayan/trajectorlets)
